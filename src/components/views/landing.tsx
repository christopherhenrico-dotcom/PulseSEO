...
export const LandingPage: React.FC<LandingPageProps> = ({ settings, logoPreview, currentTheme, setView, onThemeToggle }) => {
  const features = [
  ...
  return (
    ...
    >
      ...
      {/* Nav */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-black/50 backdrop-blur-xl border-b border-gray-200 dark:border-white/10">
      ...
      <main className="relative max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="text-center space-y-8 my-16">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-gray-100 dark:bg-white/10 border border-gray-200 dark:border-white/10"
          >
            <Sparkles size={14} className="text-purple-500" />
            <span className="text-gray-600 dark:text-gray-400">Now with Local AI - No API Keys Required</span>
          </motion.div>
          ...
          >
            ...
            <button onClick={() => document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' })} className="px-8 py-4 bg-white/10 dark:bg-white/5 backdrop-blur rounded-2xl hover:bg-white/20 transition-all text-base font-semibold text-gray-600 dark:text-gray-400 flex items-center justify-center gap-2">
              <DollarSign size={20} />
              View Pricing
            </button>
          </motion.div>
          ...
          >
            {stats.map((stat, i) => (
              <div key={i} className="bg-white/10 dark:bg-white/5 backdrop-blur-xl p-6 rounded-2xl text-center border border-gray-200 dark:border-white/10">
        ...
        <motion.div 
          ...
          className="mt-20"
        >
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-2 md:p-4 border border-gray-200 dark:border-white/10 shadow-2xl">
            <div className="bg-gray-100 dark:bg-white/10 rounded-2xl overflow-hidden">
              <div className="bg-gray-200 dark:bg-white/5 px-4 py-3 flex items-center gap-2">
              ...
              <div className="p-6 bg-gray-50 dark:bg-black/20 min-h-[300px] flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Click "Try Live Demo" to see the full dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="features" className="my-32">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">A complete SEO audit solution with AI-powered insights, client management, and professional reporting.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white/10 dark:bg-white/5 backdrop-blur-xl p-8 rounded-3xl hover:scale-[1.02] transition-all duration-300 group border border-gray-200 dark:border-white/10"
              >
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white group-hover:text-purple-600 transition-colors">{feature.title}</h3>
        ...
        <section id="how-it-works" className="my-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Simple to Use</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Get started in minutes. No setup required.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="relative">
                {i < 2 && <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 text-gray-400"><ArrowRight size={24} /></div>}
                <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl p-8 rounded-3xl text-center border border-gray-200 dark:border-white/10">
        ...
        <section className="my-32">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Loved by Agencies</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400">See what SEO professionals are saying</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, i) => (
              <div key={i} className="bg-white/10 dark:bg-white/5 backdrop-blur-xl p-8 rounded-3xl border border-gray-200 dark:border-white/10">
        ...
        <section id="pricing" className="my-32 pb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Simple, One-Time Pricing</h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">No monthly fees. No subscriptions. Own the code forever.</p>
          </div>

          <div className="max-w-xl mx-auto">
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-xl rounded-3xl p-10 border-2 border-purple-500/30 relative overflow-hidden">
              ...
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Complete Source Code</h3>
                <p className="text-gray-600 dark:text-gray-400">Everything you need to build your SEO agency</p>
              </div>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-gray-200 dark:border-white/10 bg-white/50 dark:bg-black/50">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <a href="#" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">Support</a>
          </div>
        </div>
      </footer>
    </motion.div>
